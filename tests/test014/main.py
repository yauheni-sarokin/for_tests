...
(но урезанный) интерфейс к сложной системе объектов, библиотеке
или фреймворку.
"""
...
class Facade:
    ...
    def __init__(self, subsystem1: Subsystem1, subsystem2: Subsystem2) -> None:
        ...
        #One common way to use the Python or operator is to select an
        # object from a set of objects according to its truth value. You
        # can do this by using an assignment statement:
